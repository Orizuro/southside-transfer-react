...
const MapComponent: React.FC<MapComponentProps> = () => {
  ...
  const formSchema = v.object({
    dateTime: v.string([
      v.minLength(1, 'Please enter your date')
    ]),

    totalSuitcases: v.coerce(
      ...
      <form onSubmit={handleSubmit(onSubmit)} >
        ...
        <div className=' flex justify-between'>
          ...
          <button
            ...
            className='m-8 font-bold bg-gradient-to-tr from-blue to-green hover:bg-gradient-radial rounded-full px-8 py-4'
          // href={{
          //   pathname: '/checkout',
          // }}
          >
