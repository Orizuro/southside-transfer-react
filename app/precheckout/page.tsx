...
const MapComponent: React.FC<MapComponentProps> = () => {
    ...
    if (typeof window !== 'undefined') {
        ...
        data = { destination: "", nPassenger: 0, origin: "", time: "", price: 0, timeOfPickup: "", dateOfPickup: "", child: 0, additionInfo: "", adult: 0, infant: 0, olddata: "", TotalLuggage: 0 }
